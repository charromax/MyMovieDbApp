...
import com.example.mymoviedbapp.android.common.Detail
import com.example.mymoviedbapp.android.common.Home
import com.example.mymoviedbapp.android.common.MovieAppBar
import com.example.mymoviedbapp.android.common.movieDestinations
import com.example.mymoviedbapp.android.detail.DetailScreen
import com.example.mymoviedbapp.android.detail.DetailScreenState
import com.example.mymoviedbapp.android.detail.DetailViewModel
import com.example.mymoviedbapp.android.home.HomeScreen
...
fun MovieApp() {
    ...
    val statusBarColor =
        if (isSystemDark) MaterialTheme.colors.primaryVariant else Color.Transparent
        ...
        NavHost(
            ...
            composable(Home.routeWithArgs) {
                ...
                HomeScreen(
                    ...
                    navigateToDetail = {
                        navController.navigate("${Detail.route}/$it")
                    }
                )
            }
